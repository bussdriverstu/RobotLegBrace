...
while True:
    try:   
        ...
        threshold = PotentiometerToThreshold(potentiometer.value) # Gets the position of the slider and translates it to the y-value threshold the acceleromter must surpass for the leg to bend.
        print(str(threshold))
    ...
    time.sleep(.05) # An artifical speed limit on the program. When I was gathering data for my walking gait I had the program spit out a csv file. In order to keep the file from being huge I limited the data with this. It can probably be removed entirely, though. I believe the accelerometer I used can report data at 300hz.
